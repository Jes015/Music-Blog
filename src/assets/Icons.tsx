...
// icon:heart | Ant Design Icons https://ant.design/components/icon/ | Ant Design
export const IconLike: ComponentIcon = (props) => {
  return (
    <svg
      viewBox="0 0 1024 1024"
      fill="currentColor"
...
// icon:play-circle-fill | Bootstrap https://icons.getbootstrap.com/ | Bootstrap
export const IconPlay: ComponentIcon = (props) => {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 16 16"
...
export const IconCheck: ComponentIcon = (props) => {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 16 16"
...
// icon:timelapse | CSS Icons https://css.gg/ | Astrit
export const IconPending: ComponentIcon = (props) => {
  return (
...
// icon:smile-none | CSS Icons https://css.gg/ | Astrit
export const IconImposible: ComponentIcon = (props) => {
  return (
    <svg fill="none" viewBox="0 0 24 24" height="1em" width="1em" {...props}>
      <path
        fill="currentColor"
...
export const IconPinned: ComponentIcon = (props) => {
  return (
    <svg
      fill="none"
      stroke="currentColor"
